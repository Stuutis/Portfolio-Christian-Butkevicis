...
export function LinkedinIcon() {
  return (
    <a
      className="cursor-pointer"
      href="https://www.linkedin.com/in/christian-butkevicis/"
      target="_blank"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export function YoutubeIcon() {
  return (
    <a href="https://youtube.com/@StuutisB?si=52Hv7Fo9OYsNJjz8" target="_blank">
      <svg
...
export function TwitterIcon() {
  return (
    <a href="https://twitter.com/ChrisB_Dev" target="_blank">
      <svg
        xmlns="http://www.w3.org/2000/svg"
